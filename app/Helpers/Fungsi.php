...
class Fungsi{
    ...
    public function urut_akhir($urut_akhir)
    {
     ...
     * @return view
     */
    public function edit_link($id, $url = '#', $text = "<i class='fa fa-pencil-square'></i> Edit")
    {
        $vars = compact('url', 'text', 'id');
        return view('vendor.helpers.edit', $vars);
    }

    public function create_link($url = '#', $text = "<i class='fa fa-plus-square'></i> create")
    {
        return view('vendor.helpers.create_link', compact('url', 'text'));
    }

    public function delete_link($id, $url)
    {
        return view('vendor.helpers.delete_link', compact('id', 'url'));
    }
