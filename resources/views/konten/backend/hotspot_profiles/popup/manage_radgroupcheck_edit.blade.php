...
<div class="row">
	<div class="col-md-12">
		...
		<div class="form-group">
			...
			{!! Form::text('attribute', $radgroupcheck->attribute, ['id' => 'attribute', 'placeholder' => 'attribute profile...', 'class' => 'form-control']) !!}
		</div>

		<div class="form-group">
			{!! Form::label('op', 'Op :') !!}
			{!! Form::text('op', $radgroupcheck->op, ['id' => 'op', 'placeholder' => 'op profile...', 'class' => 'form-control']) !!}
		</div>

		<div class="form-group">
			{!! Form::label('value', 'Value :') !!}
			{!! Form::text('value', $radgroupcheck->value, ['id' => 'value', 'placeholder' => 'value profile...', 'class' => 'form-control']) !!}
		</div>
...
$('#simpan').attr('disabled', 'disabled');
	$.ajax({
		url : '{{ route("backend.hotspot_profile.manage_radgroupcheck_update") }}',
		data : form_data,
		type : 'post',
